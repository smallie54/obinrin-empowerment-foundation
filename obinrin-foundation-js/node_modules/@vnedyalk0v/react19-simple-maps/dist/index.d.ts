...
declare function MapWithMetadata({ metadata, enableSEO, enableOpenGraph, enableTwitterCards, enableJsonLd, preset, children, ...mapProps }: MapWithMetadataProps): react.JSX.Element;
...
declare function GeographyErrorBoundary({ children, fallback, onError, }: GeographyErrorBoundaryProps): react.JSX.Element;
